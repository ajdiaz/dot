...
c.aliases = {
    ...
    'q': 'quit',
    'wq': 'quit --save',
    'password-fill': 'spawn --userscript /usr/share/qutebrowser/userscripts/password_fill',
    'mpv': 'spawn --userscript /usr/share/qutebrowser/userscripts/view_in_mpv',
    'youtube-dl': 'spawn --userscript ~/.config/qutebrowser/userscripts/youtube-dl',
    'q!': 'quit',
    'buffer-save': 'spawn --userscript ~/.config/qutebrowser/userscripts/buffer-save'
}
...
c.colors.completion.item.selected.fg = '#5d567f'
...
c.colors.completion.scrollbar.bg = c.colors.completion.even.bg
...
c.colors.tabs.selected.even.bg = '#5d567f'
...
c.content.headers.accept_language = 'en-US,en,es-ES,es'
...
c.hints.border = '1px solid #51c4d4'
...
c.tabs.indicator_padding = {'top': 2, 'bottom': 2, 'left': 2, 'right': 4}
...
# config.bind('g^', 'tab-focus 1')
config.bind('<Ctrl-Tab>', 'tab-focus -1')
...
config.bind('<Ctrl-P>', 'password-fill', mode='insert')
